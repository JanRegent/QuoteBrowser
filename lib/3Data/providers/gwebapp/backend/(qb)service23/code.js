...
function doGet(e) {
  ...
  try {
    ...
    // ?action=searchWord5&word1=opice
    // ?action=searchWord5&word1=opice&word2=jev
    // ?action=searchWord5&word1=opice&word2=jev&scope=sheetGroup:advaitaDaily
    // ?action=searchWord5&word1=připoutanost&word2=láska
    if (action == 'searchWord5') {
      return searchWord5(e.parameter.scope, e.parameter.word1, e.parameter.word2, e.parameter.word3, e.parameter.word4, e.parameter.word5);
    }
