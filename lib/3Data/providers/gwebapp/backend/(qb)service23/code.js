...
function doGet(e) {
  ...
  try {
    ...
    // ?action=fulltextWord5&word1=opice
    // ?action=fulltextWord5&word1=opice&word2=jev
    // ?action=fulltextWord5&word1=opice&word2=jev&scope=sheetGroup:advaitaDaily
    // ?action=fulltextWord5&word1=připoutanost&word2=láska
    if (action == 'fulltextWord5') {
      return fulltextWord5(e.parameter.scope, e.parameter.word1, e.parameter.word2, e.parameter.word3, e.parameter.word4, e.parameter.word5);
    }
