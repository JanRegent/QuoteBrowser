...
function doGet(e) {
  ...
  try {
    ...
    // ?action=setCell&sheetName=EMTdaily&sheetId=12ccbLbRfZ94gk-ZTxwj-NXJVNt4oSDjd9mHqxCh-4Uc&columnName=book&rowNo=675&cellContent=123f ined
    if (action == 'setCell') {
    ...
    // ?action=appendQuote&sheetName=EduardT&sheetId=12ccbLbRfZ94gk-ZTxwj-NXJVNt4oSDjd9mHqxCh-4Uc&parPage=321&author=Tomáš Eduard&quote=7894
