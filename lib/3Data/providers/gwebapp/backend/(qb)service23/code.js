...
function doGet(e) {
  ...
  try {
    ...
    // ?action=setCell&sheetName=EMTdaily&sheetId=12ccbLbRfZ94gk-ZTxwj-NXJVNt4oSDjd9mHqxCh-4Uc&columnName=book&rowkey=xxx675&cellContent=123f ined
    if (action == 'setCell') {
      if (e.parameter.rowkey == undefined) return buildResponse([], 'Error: setCell -- rowkey is missing ');
      return setCell(e.parameter.sheetName, e.parameter.sheetId, e.parameter.rowkey, e.parameter.columnName, e.parameter.cellContent);
    }
