...
function fullText5wordsinService(word1, word2, word3, word4, word5) {
    try {
        var data = fullText5wordsinService_(word1, word2, word3, word4, word5);
...
function fullText5wordsinService_(word1, word2, word3, word4, word5) {
    logclear()
...
function fullText5words_inService___test() {
    ...
    fullText5wordsinService_('opice', 'jev', '', '', '')

    //todo 5 proti 5 textFinder5Sheets_
