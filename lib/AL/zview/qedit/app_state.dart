...
class AppStateWidgetState extends State<AppStateWidget> {
  ...
  void updateToggleButtonsStateOnSelectionChanged(
    ...
    for (final TextStyle style in replacementStyles) {
      ...
      if (style.fontStyle != null &&
          !hasChanged.contains(ToggleButtonsState.yellowtext)) {
        _data = _data.copyWith(
          toggleButtonsState: Set.from(_data.toggleButtonsState)
            ..add(ToggleButtonsState.yellowtext),
        );
        hasChanged.add(ToggleButtonsState.yellowtext);
      }
    ...
    for (final TextStyle style in replacementStyles) {
      ...
      if (style.fontStyle == null &&
        ...
        _data = _data.copyWith(
          toggleButtonsState: Set.from(_data.toggleButtonsState)
            ..remove(ToggleButtonsState.yellowtext),
        );
        hasChanged.add(ToggleButtonsState.yellowtext);
      }
  ...
  void updateToggleButtonsStateOnButtonPressed(int index) {
    ...
    debugPrint(
        '${controller.selection.start}-${controller.selection.end} ${controller.selection.copyWith()}');
